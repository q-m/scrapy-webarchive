...
class WaczFileCreator:
    ...
    def write_datapackage(self, zip_file: zipfile.ZipFile) -> None:
        ...
        with zip_file.open("archive/" + self.warc_fname) as warc_file:
            package_dict = self.update_package_metadata_from_warc(warc_file, package_dict)
    ...
    def create_package_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": "This is the web archive generated by a scrapy-webarchive extension for the " \
            ...
            "software": f"Powered by scrapy-webarchive/{scrapy_webarchive_version}, using Scrapy/{scrapy_version}",
        }

    def update_package_metadata_from_warc(self, warc_file: IO, package_dict: Dict[str, Any]) -> Dict[str, Any]:
        """Updates the package dictionary with metadata from the WARC records."""

        warc_reader = WARCReader(gzip.open(warc_file)) if warc_file.name.endswith(".gz") else WARCReader(warc_file)
